...
values = [
    ...
    ["=B4/A4", "=C4/B4", "=B4+C4", "=1%", "=1,8%"],

    ["Полезный хешрейт", "Партнёр хешрейт", "Разработчик хешрейт", "", ""],
    ["=C6-C6*D4", "=C4*D6", "=C4*E6", "", ""],

    ["", "Доход 30 дней,BTC(Партнёр)", "Доход 30 дней,BTC(Разработчик)", "", ""],
    ["", "=(30*86400*3,125*B8*1E12)/(C2*2^32)", "=(30*86400*3,125*C8*1E12)/(C2*2^32)", "", ""],
