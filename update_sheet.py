...
values = [
    ...
    ["=1000", "=A4*A6", "=B4+B6", "=SUM(D6:E6)", "=C4*D4"],

    ["Средний хешрейт на майнер", "Прирост хешрейта", "", "Партнер", "Разработчик"],
    ["=150", "=B4*A8", "", "=1%", "=1.8%"],

    ["Кожфф. прироста ", "Суммарный хешрейт", "", "=C4*D6", "=C4*E6"],
    ["=15%", "=B4+B6", "Доход за 30 дней, BTC", "=(30*86400*3.125*D7*1000000000000)/(C2*4294967296)", "=(30*86400*3.125*E7*1000000000000)/(C2*4294967296)"],

    ["Полезный хешрейт, Th", "=B8-B8*D4", "Доход за 30 дней, USDT", "=D8*B2", "=E8*B2"]
]
