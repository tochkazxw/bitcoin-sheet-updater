...
values = [
    ...
    ["Количество майнеров", "Стоковый хешрейт", "Привлеченный хешрейт", "Распределение", "Хеш к распределению"],
    ["=1000", "=A4*A6", "=B4*A8", "=0.028", "=C4*D4"],

    ["Средний хеш на майнер", "Прирост хешрейта", "Суммарный хешрейт", "Партнер", "Разработчик"],
    ["=150", "=B6*A10", "=B6+C6", "0.01", "0.018"],

    ["Коэфф. прироста", "Полезный хешрейт", "", "Партнерский хеш", "Разработческий хеш"],
    ["=0.15", "=B10 - (B10 * D4)", "", "=C5*D6", "=C5*E6"],
