...
values = [
    ...
    [1000, 150000, 172500, 0.028, f"=C{r+3}*D{r+3}"],
    ...
    [
        f"=B{r+7}*0.9736",
        f"=3.125*D{r+7}*1000000000000/(C{r+1}*4294967296)",
        f"=3.125*E{r+7}*1000000000000/(C{r+1}*4294967296)"
    ],
