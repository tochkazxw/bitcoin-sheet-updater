...
header_sheet = get_or_create_worksheet(spreadsheet, "Headers")
data_sheet = get_or_create_worksheet(spreadsheet, "Data")
...
# Дополнительные значения (твой пример)
miners = 1000
...
# Добавляем данные (новые строки) в лист "Data" без удаления старых данных
for row in rows:
