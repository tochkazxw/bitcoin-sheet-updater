...
# Доходы
partner_btc_income = "0.02573522"
developer_btc_income = "0.04632340"
partner_usdt_income = "2702.20"
developer_usdt_income = "4863.96"
...
rows = [
    ...
    [useful_hashrate, partner_btc_income, developer_btc_income],
    [],
    ["Полезный хешрейт, Th", "Доход за 30 дней, USDT (Партнёр)", "Доход за 30 дней, USDT (Разработчик)"],
    [useful_hashrate, partner_usdt_income, developer_usdt_income]
]
