...
values = [
    ...
    ["=1000", "=A6*A8", "=B6*A10", "=2,8%", "=C6*D6"],

    ["Средний хеш на майнер", "Коэф. прироста", "Суммарный хешрейт", "Партнёр, %", "Разработчик, %"],
    ["=150", "=15%", "=B6+C6", "=1%", "=1,8%"],

    ["Полезный хешрейт", "Партнёр хешрейт", "Разработчик хешрейт", "Суммарный к распределению", ""],
    ["=A10-A10*D6", "=C6*D8", "=C6*E8", "=SUM(D10:E10)", ""],

    ["", "Доход 30 дней,BTC(Партнёр)", "Доход 30 дней,BTC(Разработчик)", "", ""],
    ["", "=(30*86400*3,125*B10*1E12)/(C2*2^32)", "=(30*86400*3,125*C10*1E12)/(C2*2^32)", "", ""],
